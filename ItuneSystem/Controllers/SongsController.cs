...
namespace ItuneSystem.Controllers
{
    public class SongsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Album,ReleaseDate,ArtistId")] Song song)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Album,ReleaseDate,ArtistId")] Song song)
        {
            if (ModelState.IsValid)
            {
